...
print("Starting weights" + str(neural_network.weights))

neural_network.train(training_set_examples, num_of_iterations=10000)

print("Trained weights" + str(neural_network.weights))

new_situation = [1,0,0]
prediction = neural_network.think(new_situation)

print("Prediction for "+ str(new_situation) + " ? " + str(prediction))
